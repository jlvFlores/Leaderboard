...
**[Leaderboard]** is a project aimed at showing us how to use API's, async and promises.
...
- Currently has a simple layout based on the wireframe given to us.
...
- With the use of [GitHub pages]() (Note: Not yet implemented.)
...
Clone this [repository](https://github.com/jlvFlores/Leaderboard) to your desired folder
...
You can deploy this project using:  Using [GitHub pages]() (Note: Not yet implemented.)
...
If you like this project you can buy some tea. (not a coffee fan)
